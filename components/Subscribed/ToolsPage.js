...
export default function ToolsPage() {
  ...
  const tools = [
    ...
    { id: 'depth-map', name: 'Depth Map Generator', description: 'Convert photos into 3D height maps for displacement.', credits: 1, thumbnail: '/Depth-Map-Thumbnail.jpg', path: '/depth-map', themeColor: '#000000' },
    { id: 'image-to-pbr', name: 'Image to PBR', description: 'Convert photos into complete PBR texture sets.', credits: 2, thumbnail: '/Image-to-PBR-Thumbnail.png', path: '/image-to-pbr', themeColor: '#ff9500' },
